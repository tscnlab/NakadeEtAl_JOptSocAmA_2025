...
class ImageSetWeights:
    def __init__(self, image_shape_, num_images_, fov_, fov_axis_, camera_directions_, front_):
        ...
        x_min, x_max, x_mid, y_min, y_max, y_mid = xy_min_max_mid(image_shape_, fov_, fov_axis_)
        solid_angles_1_image = solid_angle_limits_x_y(x_min, x_max, y_min, y_max)
        ...
        pixel_coordinates_1_image = normalize(np.stack([x_mid, y_mid, -np.ones(image_shape_)], axis=2))
